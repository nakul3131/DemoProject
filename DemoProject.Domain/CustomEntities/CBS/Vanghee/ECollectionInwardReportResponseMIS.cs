...
namespace DemoProject.Domain.CustomEntities.CBS.Vanghee
{
    ...
    public class ECollectionInwardReportResponseMISResult
    {
        [JsonProperty("status")]
        ...
        [JsonProperty("mis")]
        public ECollectionInwardReportResponseMIS[] eCollectionInwardReportResponseMIS { get; set; }
        
    }
    public class ECollectionInwardReportResponseMIS
    {
