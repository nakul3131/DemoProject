...
namespace DemoProject.Domain.Entities.Management.Servant
{
    ...
    public partial class EmployeeDesignation
    {
        ...
        {
            EmployeeDesignationMakerCheckers = new HashSet<EmployeeDesignationMakerChecker>();
        }
        ...
        public virtual ICollection<EmployeeDesignationMakerChecker> EmployeeDesignationMakerCheckers { get; set; }
    }
}
