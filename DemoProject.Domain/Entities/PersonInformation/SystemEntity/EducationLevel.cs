...
namespace DemoProject.Domain.Entities.PersonInformation.SystemEntity
{
    ...
    public partial class EducationLevel
    {
        ...
        public EducationLevel()
        {
            ...
            EducationLevelTranslations = new HashSet<EducationLevelTranslation>();
        }
        ...
        [Required]
        [StringLength(100)]
        public string NameOfEducationLevel { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<EducationLevelTranslation> EducationLevelTranslations { get; set; }
    }
}
