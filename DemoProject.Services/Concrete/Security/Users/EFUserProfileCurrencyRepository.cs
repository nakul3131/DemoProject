...
{
    public class EFUserProfileCurrencyRepository : IUserProfileCurrencyRepository
    {
        private readonly EFDbContext context;

        public EFUserProfileCurrencyRepository(RepositoryConnection _connection)
        {
            context = _connection.EFDbContext;
        }

        public async Task<IEnumerable<UserProfileCurrencyViewModel>> GetRejectedUserProfileCurrencyEntries(short _userProfilePrmKey)
        {
            try
            {
        ...
        public async Task<IEnumerable<UserProfileCurrencyViewModel>> GetUnverifiedUserProfileCurrencyEntries(short _userProfilePrmKey)
        {
            try
            {
        ...
        public async Task<IEnumerable<UserProfileCurrencyViewModel>> GetVerifiedUserProfileCurrencyEntries(short _userProfilePrmKey)
        {
            try
            {
