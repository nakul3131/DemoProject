...
{
    public class PersonInformationParameterViewModel
    {
        ...
        public PersonInformationParameterViewModel()
        {
        ...
        // PersonInformationParameterMakerCheker
        ...
        public PersonInformationParameterDocumentTypeViewModel PersonInformationParameterDocumentTypeViewModel { get; set; }

        public PersonInformationParameterNoticeTypeViewModel PersonInformationParameterNoticeTypeViewModel { get; set; }

        // For SelectListItem
        public byte PrmKeyForScript { get; set; }
        ...
        public string[] MaskTypeCharacter { get; set; }
        ...
        public string[] KYCDocumentFormatTypeIdForDatabase { get; set; }

        public string[] KYCDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] BankDocumentFormatTypeIdForDatabase { get; set; }

        public string[] BankDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] GSTDocumentFormatTypeIdForDatabase { get; set; }

        public string[] GSTDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] IncomeTaxDocumentFormatTypeIdForDatabase { get; set; }

        public string[] IncomeTaxDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] FinancialAssetDocumentFormatTypeIdForDatabase { get; set; }

        public string[] FinancialAssetDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] CommoditiesAssetDocumentFormatTypeIdForDatabase { get; set; }

        public string[] CommoditiesAssetDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] AgricultureAssetDocumentFormatTypeIdForDatabase { get; set; }

        public string[] AgricultureAssetDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] ImmovableAssetDocumentFormatTypeIdForDatabase { get; set; }

        public string[] ImmovableAssetDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] MovableAssetDocumentFormatTypeIdForDatabase { get; set; }

        public string[] MovableAssetDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] MachineryAssetDocumentFormatTypeIdForDatabase { get; set; }

        public string[] MachineryAssetDocumentFormatTypeIdForLocalStorage { get; set; }

        public string[] DeathDocumentFormatTypeIdForDatabase { get; set; }

        public string[] DeathDocumentFormatTypeIdForLocalStorage { get; set; }
    }
}